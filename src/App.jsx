              ...
              <div className="overflow-y-auto bg-white flex-1 relative">
                {requestSuccess ? (
                  ...
                  <form onSubmit={submitRequest} className="p-8 sm:p-10 space-y-6">
                    ...
                    <button 
  type="submit" 
  className={`w-full text-white font-black tracking-widest uppercase py-5 rounded-2xl transition-all shadow-lg hover:shadow-xl mt-4 flex items-center justify-center gap-3 hover:-translate-y-1 text-lg ${
    requestData.type === 'mac'
      ? 'bg-blue-600 hover:bg-blue-700'
      : requestData.type === 'dogum_gunu'
      ? 'bg-purple-500 hover:bg-purple-600'
      : requestData.type === 'organizasyon'
