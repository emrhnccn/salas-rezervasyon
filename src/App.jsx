...
export default function App() {
  ...
  if (!isAuthenticated) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-slate-50 via-orange-50/40 to-emerald-50/60 font-sans text-slate-800 relative flex flex-col scroll-smooth" style={{width:'100%', maxWidth:'100vw', overflowX:'hidden'}}>
        ...
        <style dangerouslySetInnerHTML={{__html: `
          *, *::before, *::after { box-sizing: border-box; }
          ...
          @media (min-width: 480px) { .xs\\:w-auto { width: auto !important; } .xs\\:flex-row { flex-direction: row !important; } }
        `}} />
        ...
        <div className="fixed top-0 left-0 right-0 w-full z-50 pointer-events-none">
          <nav className={`w-full pointer-events-auto transition-all duration-500 ${isScrolled ? 'bg-white/95 backdrop-blur-md shadow-md py-3 border-b border-slate-200' : 'bg-transparent py-5 sm:py-6'}`}>
            <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
              ...
              <div className={`hidden xl:flex flex-1 justify-center items-center gap-6 lg:gap-10 font-bold text-sm lg:text-base transition-colors duration-500 ${isScrolled ? 'text-slate-700' : 'text-white drop-shadow-md'}`}>
              ...
              <div className="shrink-0 flex justify-end gap-2 sm:gap-3">
                {/* Rezervasyon butonu - mobilde ikonla küçük göster */}
                <button
                  onClick={() => { setShowRequestModal(true); }}
                  className="flex items-center gap-1.5 bg-white/10 backdrop-blur-sm border border-white/30 text-white px-3 sm:px-4 py-2 sm:py-2.5 rounded-full text-xs font-black tracking-widest uppercase hover:bg-white/20 transition-all shadow-lg whitespace-nowrap"
                >
                  <CalendarDays size={14} /> <span className="hidden sm:inline">Rezervasyon</span>
                </button>
                <a href="https://m.1menu.com.tr/salaascafe/" target="_blank" rel="noreferrer" className="shine-effect bg-orange-500 text-white px-3 sm:px-5 py-2 sm:py-2.5 lg:px-6 lg:py-3 rounded-full text-xs sm:text-sm font-black tracking-widest uppercase hover:bg-orange-600 hover:scale-105 transition-all shadow-lg whitespace-nowrap">
                  <span className="hidden sm:inline">Menüyü Gör</span><span className="sm:hidden">Menü</span>
                </a>
              </div>
            </div>
          </nav>
        ...
        {/* HERO */}
        <header className="relative w-screen min-h-[500px] h-[75vh] lg:h-[85vh] max-h-[900px] bg-slate-900 flex items-center justify-center overflow-hidden pt-16" style={{marginLeft:'calc(50% - 50vw)', marginRight:'calc(50% - 50vw)'}}>
          <div className="absolute inset-0 z-0">
            <img src="/salaasarkaplan.jpeg" alt="Salaaş Cafe Arka Plan" className="w-full h-full object-cover object-center" style={{opacity:0.55}} />
          ...
          <div className="relative z-10 text-center px-4 sm:px-6 w-full max-w-5xl mx-auto flex flex-col items-center justify-center h-full pb-10">
            <h1 className="text-3xl xs:text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black tracking-wide text-white font-serif mb-4 sm:mb-6 drop-shadow-2xl animate-fade-in-up delay-100 leading-tight">
              Lezzet ve <span className="text-orange-400">Muhabbetin</span> Adresi
            </h1>
            <p className="text-base sm:text-xl lg:text-2xl text-slate-200 max-w-3xl mx-auto font-medium mb-8 sm:mb-10 drop-shadow-lg animate-fade-in-up delay-200 px-2">
              Şehrin gürültüsünden uzak, samimi atmosferimizde unutulmaz tatlar ve anılar biriktirin.
            </p>
            {/* YENİ: HERO CTA BUTONLARI */}
            <div className="flex flex-col xs:flex-row flex-wrap justify-center gap-3 sm:gap-4 animate-fade-in-up delay-300 w-full px-4">
              <button
                onClick={() => setShowRequestModal(true)}
                className="shine-effect bg-orange-500 hover:bg-orange-600 text-white px-6 sm:px-8 py-3.5 sm:py-4 rounded-full font-black text-sm uppercase tracking-widest transition-all shadow-2xl hover:scale-105 flex items-center justify-center gap-2 w-full xs:w-auto"
              >
                <CalendarDays size={18} /> Rezervasyon Talebi
              </button>
              <button
                onClick={() => handleScroll('lezzetler')}
                className="bg-white/10 backdrop-blur-md border border-white/20 text-white px-6 sm:px-8 py-3.5 sm:py-4 rounded-full font-black text-sm uppercase tracking-widest hover:bg-white/20 transition-all shadow-xl flex items-center justify-center gap-2 w-full xs:w-auto"
              >
        ...
        <main className="w-full relative z-10 flex-1 flex flex-col">
          ...
          {/* LEZZETLER */}
          <section id="lezzetler" className="w-screen py-20 md:py-28 border-y border-slate-200/50 bg-white/40 backdrop-blur-md" style={{marginLeft:'calc(50% - 50vw)', marginRight:'calc(50% - 50vw)'}}>
          ...
          {/* ORGANİZASYON */}
          <section className="w-screen py-24 bg-slate-900 text-white relative overflow-hidden" style={{marginLeft:'calc(50% - 50vw)', marginRight:'calc(50% - 50vw)'}}>
          ...
          {/* CANLI YOĞUNLUK */}
          <section id="rezervasyon" className="w-screen py-24 bg-slate-50" style={{marginLeft:'calc(50% - 50vw)', marginRight:'calc(50% - 50vw)'}}>
            <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* FOOTER */}
        <footer id="iletisim" className="w-screen bg-slate-950 text-slate-400 py-16 relative z-10 border-t border-slate-800" style={{marginLeft:'calc(50% - 50vw)', marginRight:'calc(50% - 50vw)'}}>
